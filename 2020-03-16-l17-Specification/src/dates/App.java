...
public class App {
	...
	public static void main(String[] args) {
		...
		LocalDate dat3 = LocalDate.of(2020, 12, 6);
		System.out.println(dat3);
		System.out.println();
		LocalDate dat4 = LocalDate.parse("2020-10-15");
		...
		System.out.println(
				"Fra " + dat1 + " til " + dat3 + " er der " + years + " år " + months + " måneder " + days + " dage");
		...
		LocalDateTime dt = LocalDateTime.of(2020, 11, 3, 10, 15);
