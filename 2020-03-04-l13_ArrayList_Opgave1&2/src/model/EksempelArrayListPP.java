...
public class EksempelArrayListPP {
	...
	public static void main(String[] args) {
		...
		System.out.println("Listen inedholder " + size + " elementer");

		System.out.println(list.get(2)); // returnerer indholdet på plads 2 i listen
		System.out.println(list.size());
		list.add("Finn"); // tilføjer Finn bagest i listen
		list.add(1, "Dan"); // indsætter Dan på plads 1. Elementerne på plads 1 og frem rykkes en plads til
							// højre
		list.remove(1); // sletter elementet på indeks plads 1 og rykker elementerne en plads til
						// venstre
