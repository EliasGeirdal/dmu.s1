...
public class MainApp extends Application {
	...
	private void initTabPane(TabPane tabPane) {
		...
		Tab tabCustomers = new Tab("Customer");
		tabPane.getTabs().add(tabCustomers);

		CustomerPane customerPane = new CustomerPane();
		tabCustomers.setContent(customerPane);
		tabCustomers.setOnSelectionChanged(event -> employeePane.updateControls());
	}
