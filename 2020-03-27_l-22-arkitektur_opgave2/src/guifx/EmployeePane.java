...
public class EmployeePane extends GridPane {
	private TextField txfName, txfWage, txfCompany, txfSalary, txfEmploymentYear; // added
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			if (employee.getCompany() != null) {
				...
				txfEmploymentYear.setText("" + employee.getEmploymentYear()); // added
			} else {
				txfCompany.clear();
				txfSalary.clear();
				txfEmploymentYear.clear(); // added
			}
		} else {
			txfName.clear();
			txfWage.clear();
