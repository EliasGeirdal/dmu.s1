...
public class Company {
	...
	/**
	 * add customer to customers if customer isnt connected.
	 * 
	 * @param customer
	 */
	...
	/**
	 * removes customer if customer is connected.
	 * 
	 * @param customer
	 */
	...
	/**
	 * Removes the employee from this company, if the are connected
	 * 
	 * @param employee
	 */
