...
public class Person {
	...
	/**
	 * Constructor: when describing the person, we need to know persons name,
	 * address, monthly salary etc.
	 * 
	 ...
	 * @param holidayPay    persons holiday pay calculated from 2.5 percent of
	 *                      yearly salary.
	 */
