...
public class Name {
	...
	// Collect two capital characters from first name, amount of characters of
	// middle name (displayed in int), two last characters of last name.
	// The names username is called by getUsername method.
	public String getUsername() {
		String username = firstname.toUpperCase().substring(0, 3) + middlename.length()
