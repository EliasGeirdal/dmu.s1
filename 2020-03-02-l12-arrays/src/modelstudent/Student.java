...
public class Student {
	...
	/*
	 * Man kan faa oplyst den studerendes aktivitet, ved at kalde metoden isAktiv
	 */
	...
	/*
	 * Tilføjer en karakter til den studerende. Hvis den studerende allerede har 10
	 * karakterer registreres intet
	 */
	...
	// Max grade a student has been given.
	public int maxGrade() {
		int max = grades[0];
	...
	// returns min grade a student has been given.
	public int minGrade() {
		int min = grades[0];
		for (int i = 0; i < numberOfGrades; i++) {
			if (min > grades[i])
